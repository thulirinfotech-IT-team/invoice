...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-change-this-in-production-thulirinfo-tech-2026')
...
COMPANY_EMAIL = 'techthulirinfo@gmail.com'
COMPANY_PHONE = '+91 7904730223'
COMPANY_WEBSITE = 'https://thulirinfo.in/'
COMPANY_GSTIN = ''
COMPANY_LOGO = BASE_DIR / 'static' / 'logo.png'
